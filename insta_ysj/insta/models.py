...
class Album(models.Model):
    ...
    owner = models.ForeignKey('common.CustomUserManager', on_delete=models.CASCADE, verbose_name='OWNER', blank=True, null=True)
...
class Photo(models.Model):
    ...
    owner = models.ForeignKey(CustomUserManager, on_delete=models.CASCADE, related_name='owner_photo')
    voter = models.ManyToManyField(CustomUserManager, related_name='voter_photo')
