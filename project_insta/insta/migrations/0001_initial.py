# Generated by Django 3.1.3 on 2022-03-23 01:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner_photo', to='common.user')),
                ('voter', models.ManyToManyField(related_name='voter_photo', to='common.User')),
            ],
            options={
                'ordering': ('title',),
            },
